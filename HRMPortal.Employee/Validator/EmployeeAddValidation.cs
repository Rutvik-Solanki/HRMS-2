...
{
    public class EmployeeAddValidation: AbstractValidator<EmployeeAddDto>
    {
        public EmployeeAddValidation()
        {
           ...
           /* RuleFor(e => e.DateOfJoining).GreaterThanOrEqualTo(DateOnly.FromDateTime(DateTime.Today));
            RuleFor(e => e.ConfirmationDate).GreaterThanOrEqualTo(e => e.DateOfJoining);
            RuleFor(e => e.AppraisalDate).GreaterThan(e => e.ConfirmationDate);*/
            ...
            RuleFor(e => e.CreatedAt).NotEmpty().LessThanOrEqualTo(DateTime.UtcNow);
        }
    }
}
