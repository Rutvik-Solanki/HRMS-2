...
{
    public class LeaveAddModelValidation:AbstractValidator<LeaveAddModel>
    {
        public LeaveAddModelValidation()
        {
            ...
            RuleFor(x => x.ToDate)
                ...
                .GreaterThanOrEqualTo(x => x.FromDate).LessThanOrEqualTo(x => x.FromDate.AddDays(15)).WithMessage("Must be in Range")
